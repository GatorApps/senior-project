...
const GenericPage = ({ title }) => {
    ...
    return (
        <HelmetComponent title={"Opportunity Search"}>
                    ...
                    <Box>
                        <Container maxWidth="lg">
                            <Box
                                ...
                                sx={{ 'margin-bottom': '16px', 'display': 'flex' }}
                                component="div"
                                display="flex"
                                flexDirection="column"
                            >
                                <Typography variant="h1" align="left" sx={{ margin: '16px', fontSize: '2one.5rem', fontWeight: 400 }}>Opportunity Search Page</Typography>
                                <Box className="GenericPage__container_title_flexBox" sx={{ 'flex-grow': '1', gap: '16px' }}>
                                    {/* Search bar */}
