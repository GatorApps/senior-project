...
const ApplicationPopup = ({ open, onClose, questions, postingId }) => {
  ...
  // Modal style with proper transform origin for animations
  const modalStyle = {
    display: "flex",
    alignItems: "center",
  ...
  const getContentStyle = (isSuccess) => ({
    outline: "none",
    width: isSuccess ? "90%" : "80%",
    maxWidth: isSuccess ? "600px" : "1000px",
    maxHeight: "80vh",
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            Are you sure you want to close? Your progress will be disgarded
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          ...
          <div style={getContentStyle(success)}>
            <Grow in={!success} timeout={300} style={{ transformOrigin: "center" }} mountOnEnter unmountOnExit>
              ...
              >
                    ...
                    <Box sx={{ p: 3, minHeight: 300, display: "flex", flexDirection: "column", gap: 3 }}>
                      <Box>
                        ...
                        {resumeMetadata && (
                          ...
                          >
                            <Box>
                              <Typography color="primary">{resumeMetadata.fileName}</Typography>
                      ...
                      <Box>
                        ...
                        {transcriptMetadata && (
                          ...
                          >
                            <Box>
                              <Typography color="primary">{transcriptMetadata.fileName}</Typography>
                              <Typography variant="body2" color="text.secondary">
                        ...
                        <Button variant="outlined" component="label" startIcon={<CloudUploadIcon />} disabled={loading}>
                          ...
                          <input type="file" hidden accept=".pdf" onChange={(e) => handleFileUpload(e, "transcript")} />
                        </Button>
                        <Typography variant="caption" display="block" sx={{ mt: 1 }}>
                    ...
                    <Box sx={{ p: 3, minHeight: 300, display: "flex", flexDirection: "column", gap: 3 }}>
                      {!hasSupplementalQuestions ? (
                        ...
                        <>
                          ...
                          >
                            <ReactQuill value={answers} onChange={setAnswers} placeholder="Type your answers here..." />
                          </Box>
                        </>
                      )}
                    </Box>
                ...
                >
                  <Button onClick={handleCloseRequest} color="error" variant="outlined">
                    Cancel
                  </Button>
